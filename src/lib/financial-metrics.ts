...
export function generateMockFinancialProfile(symbol: string): FinancialProfile {
  const price = 1500 + Math.random() * 3500;
  ...
  return {
    ...
    valuation: {
      ...
      evRevenue: 2 + Math.random() * 5,
      mcap,
      divYield: 0.5 + Math.random() * 3,
    },
    profitability: {
      roe: 10 + Math.random() * 25,
      roa: 5 + Math.random() * 15,
      roce: 12 + Math.random() * 20,
      grossMargin: 30 + Math.random() * 40,
      opMargin: 10 + Math.random() * 25,
      netMargin: 5 + Math.random() * 20,
      eps: 20 + Math.random() * 100,
    },
    leverage: {
      debtEquity: Math.random() * 1.5,
      currentRatio: 1 + Math.random() * 2,
      quickRatio: 0.5 + Math.random() * 1.5,
      interestCov: 3 + Math.random() * 10,
      debtAssets: 0.1 + Math.random() * 0.4,
    },
    growth: {
      revenueGrowth: -5 + Math.random() * 30,
      profitGrowth: -10 + Math.random() * 40,
      epsGrowth: -5 + Math.random() * 35,
      cagr3Y: 5 + Math.random() * 20,
      cagr5Y: 8 + Math.random() * 25,
    },
    efficiency: {
      assetTurnover: 0.5 + Math.random() * 1.5,
      inventoryTurnover: 5 + Math.random() * 15,
      receivablesTurnover: 4 + Math.random() * 12,
      workingCapital: 100000000 + Math.random() * 500000000,
      fixedAssetTurnover: 1 + Math.random() * 3,
    },
